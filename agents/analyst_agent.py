...
Your job is to synthesize insights and identify key drivers based ONLY on the data provided.

STRICT CONTEXT GROUNDING:
- Answer ONLY from the provided Data context.
- Do NOT use outside knowledge or hallucinate.
- If the context is completely empty or completely unrelated to the query, output exactly: {{"problem_analysis": "Insufficient data", "key_drivers": []}}
...
Ensure all drivers are directly supported by the retrieved Data.
"""
